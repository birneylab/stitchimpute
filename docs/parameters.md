...
| `snp_filtering_criteria` | CSV file containing the threshold for inclusion of SNPs in the iterative refinement process <details><summary>Help</summary><small>By default the `info_score` value of the SNP is used for filtering if a ground truth is not provided, and the Pearson r^2 if a ground truth is provided. This can be changed with the `filter_var` parameter.</small></details>| `string` |  |  |  |
...
| `glimpse2_concordance_bins` | MAF bins for calculating validation performance <details><summary>Help</summary><small>Allele frequency bins used for r^2 computations. By default they should as MAF bins [0-0.5], while they should take the full range [0-1] if –use-ref-alt is used.</small></details>| `string` | 0 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.5 |  | True |
